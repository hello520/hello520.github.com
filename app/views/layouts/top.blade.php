    ...
    <div class="top-nav-inner">
        <div class="nav-header">
                    ...
                    <ul class="dropdown-menu dropdown-sm pull-right user-dropdown">
                        <li class="user-avatar">
                            ...
                            <div class="user-content">
                                <h5 class="no-m-bottom">Tome</h5>
                                <div class="m-top-xs">
                                    <a href="{{URL::action('UserController@index')}}" class="m-right-sm">Profile</a>
                                    @if(1)
                                        <a href="{{url('user/index')}}">退出登陆</a>
                                    @else
                                        <a href="">Log out</a>
                                    @endif
                                </div>
            ...
            <a href="index.html" class="brand">
                <i class="fa fa-database"></i><span class="brand-name"> LARAVEL CMS</span>
            </a>
        </div>
